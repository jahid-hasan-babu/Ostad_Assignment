              ...
              >
                ...
                <div className="mt-2">
                  <button>
                    <NavLink
                      to="/login"
                      className="btn btn-outline btn-success text-transform: capitalize"
                    >
                      Login
                    </NavLink>
                  </button>
                  <button>
                    <NavLink
                      to="/register"
                      className="btn ml-4 btn-success text-transform: capitalize  text-cyan-50"
                    >
                      Register
                    </NavLink>
                  </button>
            ...
            <ul className="menu menu-horizontal px-1 ">
              ...
              <div>
                <button>
                  <NavLink
                    to="/login"
                    className=" btn ml-2 btn-outline btn-success 	text-transform: capitalize"
                  >
                    Login
                  </NavLink>
                </button>
